...
#     ## LOF mutations analysis 
#     lof <- c("frameshiftdeletion","frameshiftinsertion","stopgain","stoploss","none")                 
#     case1 <- case3[case3[,"VariantClass"] %in% lof,]    
#     cont1 <- cont3[cont3[,"VariantClass"] %in% lof,]
#     case1 <- case1[case1[,"Gene"] %in% agenes,]
#     cont1 <- cont1[cont1[,"Gene"] %in% agenes,]
#     a <- variant_type_burden_sig(case1,cont1)
#     print(a)
#     
#     ## missense mutations in cosmic hotspots analysis
#     caseind <- nchar(case3[,"REF"]) != nchar(case3[,"ALT"])
#     contind <- nchar(cont3[,"REF"]) != nchar(cont3[,"ALT"])    
#     mis <- c("nonframeshiftdeletion","nonframeshiftinsertion","nonsynonymousSNV")
#     case2 <- case3[case3[,"VariantClass"] %in% mis & !caseind,]
#     cont2 <- cont3[cont3[,"VariantClass"] %in% mis & !contind,]
#     case2 <- case2[case2[,"Gene"] %in% agenes,]
#     cont2 <- cont2[cont2[,"Gene"] %in% agenes,]
# 
#     a <- variant_type_burden_sig(case2,cont2)
#     print(a)
#     
#     
#     ## indels analysis
#     case4 <- case3[case3[,"VariantClass"] %in% mis & caseind,]
#     cont4 <- cont3[cont3[,"VariantClass"] %in% mis & contind,]
#     case4 <- case4[case4[,"Gene"] %in% agenes,]
#     cont4 <- cont4[cont4[,"Gene"] %in% agenes,]    
#     a <- variant_type_burden_sig(case4,cont4)
#     print(a)
